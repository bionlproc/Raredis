...
text_path = "/Users/shashankgupta/Desktop/BioGPT_inputTest/Raredis_corrected_annotation/final_corrections/test" \
            "/input_text"
final_doc = dict()
null_cnt = 0

with open('/Users/shashankgupta/Documents/Raredis/BioMedLM/Instruction_data2/test.json', 'w') as outfile:
    for document in os.listdir(ann_path):
        ...
        with open(os.path.join(ann_path, document), "r") as in_f:
            ...
            if doc_type == ".ann":
                ...
                # without copy instruction
                # content = "consider the abstract: $ " + content + " $ in the given abstract, " \
                #                                                   "all the relations present are "
                ...
                # with abs
                content = "consider the abstract: $ " + content + " $ from the given abstract, " \
                                                                  "find all the entities and relations among them. " \
                                                                  "do not generate any token outside the abstract."
