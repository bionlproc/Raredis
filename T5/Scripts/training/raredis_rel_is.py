...
# pydevd_pycharm.settrace('localhost', port=3498, stdoutToServer=True, stderrToServer=True)
...
with open('/home/ubuntu/FlanT5/Raredis/data/no_copy_relis/train.json', 'r') as file:
...
with open('/home/ubuntu/FlanT5/Raredis/data/no_copy_relis/valid.json', 'r') as file:
