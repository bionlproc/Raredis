...
import args_ent_train as args
# import args_ent_test as args
...
if __name__ == '__main__':
    ...
    #
    # parser.add_argument('--task', type=str, default=None, required=True, choices=['ace04', 'ace05', 'scierc', 'raredis'])
    #
